...
public class T1_StaleElementRefEx {
    ...
    public static void main(String[] args) throws InterruptedException{
        ...
        //WebElement deleteElementBtn = driver.findElement(By.xpath("//button[.='Delete']"));
        WebElement deleteElementBtn = driver.findElement(By.xpath("//button[@class='added-manually']"));

        System.out.println("deleteButton.isDisplayed() = " + deleteElementBtn.isDisplayed());
